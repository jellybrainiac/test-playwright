...
- Location: D:\oryza\tests\login.spec.js:26:3
...
Call log:
  ...
  - waiting for getByText(/Invalid username or password|Không thể đăng nhập/i)
    ...
    at D:\oryza\tests\login.spec.js:32:87
```
...
- text: Nhớ tài khoản
- link "Quên mật khẩu?":
  - /url: /realms/oryza-systems/login-actions/reset-credentials?client_id=oryza-metadata&tab_id=kWkooaRJgUs&client_data=eyJydSI6Imh0dHBzOi8vbWV0YWRhdGEub3J5emEudm4vYXBpL2F1dGgvY2FsbGJhY2sva2V5Y2xvYWsiLCJydCI6ImNvZGUiLCJzdCI6IlFvYmpaLXRnaUFIdjNrQUdSU3pqX0JPVC1IdmNOZ2cxWmRZUVJsLXNZVkkifQ
- button "Đăng nhập" [disabled]
- text: Bạn chưa có tài khoản?
- link "Đăng ký":
  - /url: /realms/oryza-systems/login-actions/registration?client_id=oryza-metadata&tab_id=kWkooaRJgUs&client_data=eyJydSI6Imh0dHBzOi8vbWV0YWRhdGEub3J5emEudm4vYXBpL2F1dGgvY2FsbGJhY2sva2V5Y2xvYWsiLCJydCI6ImNvZGUiLCJzdCI6IlFvYmpaLXRnaUFIdjNrQUdSU3pqX0JPVC1IdmNOZ2cxWmRZUVJsLXNZVkkifQ
- separator: Hoặc
- list:
  - listitem:
    - link "Tiếp tục với Google":
      - /url: /realms/oryza-systems/broker/google/login?client_id=oryza-metadata&tab_id=kWkooaRJgUs&client_data=eyJydSI6Imh0dHBzOi8vbWV0YWRhdGEub3J5emEudm4vYXBpL2F1dGgvY2FsbGJhY2sva2V5Y2xvYWsiLCJydCI6ImNvZGUiLCJzdCI6IlFvYmpaLXRnaUFIdjNrQUdSU3pqX0JPVC1IdmNOZ2cxWmRZUVJsLXNZVkkifQ&session_code=MWWebAVpyH4E_ZX6y4733VnWbBZB3dxIGxfoH7Pexpg
