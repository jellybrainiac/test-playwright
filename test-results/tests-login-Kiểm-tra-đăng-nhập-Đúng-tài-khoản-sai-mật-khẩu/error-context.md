...
- Location: D:\oryza\tests\login.spec.js:27:3
...
Call log:
  ...
  - waiting for getByText(/Invalid username or password|Không thể đăng nhập/i)
    ...
    at D:\oryza\tests\login.spec.js:33:87
```
...
- text: Nhớ tài khoản
- link "Quên mật khẩu?":
  - /url: /realms/oryza-systems/login-actions/reset-credentials?client_id=oryza-metadata&tab_id=LvLDNDjOGLc&client_data=eyJydSI6Imh0dHBzOi8vbWV0YWRhdGEub3J5emEudm4vYXBpL2F1dGgvY2FsbGJhY2sva2V5Y2xvYWsiLCJydCI6ImNvZGUiLCJzdCI6Im9GVUJMS0ZaNXJIRUNadWN2Y0lWSkFXdHd6REdINkdVaDJQaWttSUxhN1UifQ
- button "Đăng nhập" [disabled]
- text: Bạn chưa có tài khoản?
- link "Đăng ký":
  - /url: /realms/oryza-systems/login-actions/registration?client_id=oryza-metadata&tab_id=LvLDNDjOGLc&client_data=eyJydSI6Imh0dHBzOi8vbWV0YWRhdGEub3J5emEudm4vYXBpL2F1dGgvY2FsbGJhY2sva2V5Y2xvYWsiLCJydCI6ImNvZGUiLCJzdCI6Im9GVUJMS0ZaNXJIRUNadWN2Y0lWSkFXdHd6REdINkdVaDJQaWttSUxhN1UifQ
- separator: Hoặc
- list:
  - listitem:
    - link "Tiếp tục với Google":
      - /url: /realms/oryza-systems/broker/google/login?client_id=oryza-metadata&tab_id=LvLDNDjOGLc&client_data=eyJydSI6Imh0dHBzOi8vbWV0YWRhdGEub3J5emEudm4vYXBpL2F1dGgvY2FsbGJhY2sva2V5Y2xvYWsiLCJydCI6ImNvZGUiLCJzdCI6Im9GVUJMS0ZaNXJIRUNadWN2Y0lWSkFXdHd6REdINkdVaDJQaWttSUxhN1UifQ&session_code=H_NznfbvIBvnu3cDeurksiFMYJRYPgeKMU6wja4cx88
